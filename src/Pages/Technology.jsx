...
function Technology() {
    ...
    return (
        <>
            ...
            <div>
                {technologies.map(technology => (<li >

                    {/* issue: Why does this not work => passing source of image to imageholder componant . js varifies that the value is a string and props takes it in as a string */}
                    {console.log(typeof (technology.images.portrait))}
                    <div>
                        <H1 name={technology.name} />
                        <Paragraph bio={technology.description} />
                        <ImageHolder img={technology.images.portrait} />
                    </div>
                </li>))
                }
            </div>
